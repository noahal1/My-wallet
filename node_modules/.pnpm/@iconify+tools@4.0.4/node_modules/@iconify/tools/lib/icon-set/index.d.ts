import { CheckThemeResult, CommonIconProps, IconCategory, IconSetAsyncForEachCallback, IconSetIconEntry, IconSetIconType, IconSetSyncForEachCallback, ResolvedIconifyIcon } from '@iconify/tools/lib/icon-set/types.js';
import { SVG } from '@iconify/tools/lib/svg/index.js';
...
import { ParentIconsTree } from '@iconify/utils/lib/icon-set/tree.js';
import 'cheerio';
...
export { blankIconSet, IconSet, sortThemeKeys };
