...
import { EmojiTestData, EmojiTestDataItem } from '@iconify/utils/lib/emoji/test/parse.js';
...
export { EmojiSequenceComponentEntry, EmojiSequenceComponentValues, EmojiSequenceWithComponents, emojiSequenceWithComponentsToString, EmojiTestDataComponentsMap, findEmojiComponentsInSequence, mapEmojiTestDataComponents, replaceEmojiComponentsInCombinedSequence };
