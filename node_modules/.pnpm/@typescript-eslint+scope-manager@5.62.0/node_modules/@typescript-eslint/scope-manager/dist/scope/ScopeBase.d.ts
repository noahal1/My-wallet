import type { Definition } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/definition';
import type { ReferenceImplicitGlobal } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/referencer/Reference';
import { Reference, ReferenceFlag } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/referencer/Reference';
import type { FunctionScope } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/scope/FunctionScope';
import type { GlobalScope } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/scope/GlobalScope';
import type { ModuleScope } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/scope/ModuleScope';
import type { Scope } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/scope/Scope';
import { ScopeType } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/scope/ScopeType';
import type { TSModuleScope } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/scope/TSModuleScope';
import type { ScopeManager } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/ScopeManager';
import { Variable } from '.pnpm/@typescript-eslint+scope-manager@5.62.0/node_modules/@typescript-eslint/scope-manager/src/variable';
