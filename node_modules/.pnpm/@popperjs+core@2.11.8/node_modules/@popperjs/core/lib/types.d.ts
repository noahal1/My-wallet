import type { ModifierPhases, Placement } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/enums";
import type { ApplyStylesModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/applyStyles";
import type { ArrowModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/arrow";
import type { ComputeStylesModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/computeStyles";
import type { EventListenersModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/eventListeners";
import type { FlipModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/flip";
import type { HideModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/hide";
import type { OffsetModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/offset";
import type { PopperOffsetsModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/popperOffsets";
import type { PreventOverflowModifier } from ".pnpm/@popperjs+core@2.11.8/node_modules/@popperjs/core/lib/modifiers/preventOverflow";
